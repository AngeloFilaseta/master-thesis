...
\begin{itemize}
	...
	\centerImage{figures/sequence-server.pdf}{UML Sequence Diagram - Stadia-like Approach}{sequence-server}{1}
	...
	\centerImage{figures/sequence-client.pdf}{UML Sequence Diagram - Everything in Browser Approach}{sequence-client}{0.8}
\end{itemize}
