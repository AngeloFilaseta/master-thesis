...
float,
language=Kotlin,
caption={Module for the Serialization of Concentration},
...
\centerImage{figures/state.png}{UML Class Diagram - State Management}{state}{1}
...
\centerImage{figures/UIcomponents.png}{UI Components Hierarchy with Adapters}{components}{0.7}
