...
\centerImage{figures/stadia-approach.png}{Stadia-like Approach}{stadia-approach}{0.5}
...
\centerImage{figures/everything-in-browser-approach.png}{Everything in Browser Approach}{e-i-b-approach}{0.5}
